...
> 📌 **微信公众号草稿（2026-09-13 四篇中文全量，尚未群发）**：用
> `baoyu-post-to-wechat` 的 browser 方式推入草稿箱，appmsgid 依次为
> **01 → 100003462**、**02 → 100003466**、**03 → 100003469**、**04 → 100003472**。
> 草稿箱里还留着 2026-08-28 那批旧版本（100003447 / 100003452 / 100003456），发布前建议清理。
>
> ⚠️ **browser 方式不自动上传封面**：发布前需在草稿箱为每篇手动设封面
> （`imgs/blog-cover-01-local-first.png` / `-02-sub-second-sidepanel.png` /
> `-03-webcrypto.png` / `-04-login-flow-details.png`），并顺手填「阅读原文」
> 指向对应 canonical 页面。正文外链已按公众号惯例转为文末引用块。
